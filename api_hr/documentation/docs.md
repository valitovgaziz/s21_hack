...
Для поднятия создать .env файл с кофигами вашей PostgresQL
# DB environment variabels
DB_HOST=localhost       Подставь свои значения
DB_PORT=5432            Подставь свои значения
DB_USER=postgres        Подставь свои значения
DB_PASSWORD=postgres    Подставь свои значения
DB_NAME=pulsehr         Подставь свои значения
APP_PORT=8080           Подставь свои значения
